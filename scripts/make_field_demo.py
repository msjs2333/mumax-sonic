...
def main():
    ...
    parser.add_argument('--scenario', choices=[*SCENARIOS, *ACTIVITY_SCENARIOS], default='opposite_pair')
    parser.add_argument('--frames', type=int, default=1)
    parser.add_argument('--step-ps', type=float, default=50, help='Physical interval between recorded samples')
